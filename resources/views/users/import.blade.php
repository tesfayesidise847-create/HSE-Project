        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 overflow-hidden shadow-sm sm:rounded-lg bg-white dark:bg-gray-800">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        {{ __('Download the Excel template (.xls), fill in user data using the exact column headers, then upload the file below.') }}
                    </p>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        {{ __('Columns') }}: <strong>name</strong>, <strong>email</strong>, <strong>password</strong>, <strong>role</strong>
                    </p>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        {{ __('Available roles') }}: <strong>Admin</strong>, <strong>Employee</strong>, <strong>HSE Officer</strong>, <strong>HSE Site Officer</strong>
                    </p>
                    <a href="{{ route('users.import.template') }}" class="mt-4 inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500">
            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg bg-white dark:bg-gray-800">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('users.import.store') }}" enctype="multipart/form-data" class="mt-4">
                        @csrf
                        ...
                        <div class="mt-6 flex items-center gap-4">
                            ...
                            <a href="{{ route('users.index') }}" class="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
